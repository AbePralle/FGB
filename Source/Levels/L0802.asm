...
L0802_CheckFinished:
PRINT "0802 Script Sizes (Load/Init/Check) (of $500):  "
PRINT (L0802_LoadFinished - L0802_Load2)
PRINT " / "
PRINT (L0802_InitFinished - L0802_Init2)
PRINT " / "
PRINT (L0802_CheckFinished - L0802_Check2)
PRINT "\n"
