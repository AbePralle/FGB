...
L0804_CheckFinished:
PRINT "0804 Script Sizes (Load/Init/Check) (of $500):  "
PRINT (L0804_LoadFinished - L0804_Load2)
PRINT " / "
PRINT (L0804_InitFinished - L0804_Init2)
PRINT " / "
PRINT (L0804_CheckFinished - L0804_Check2)
PRINT "\n"
