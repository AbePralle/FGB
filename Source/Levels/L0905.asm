...
L0905_CheckFinished:
PRINT "0905 Script Sizes (Load/Init/Check) (of $500):  "
PRINT (L0905_LoadFinished - L0905_Load2)
PRINT " / "
PRINT (L0905_InitFinished - L0905_Init2)
PRINT " / "
PRINT (L0905_CheckFinished - L0905_Check2)
PRINT "\n"
