...
L0801_CheckFinished:
PRINT "0801 Script Sizes (Load/Init/Check) (of $500):  "
PRINT (L0801_LoadFinished - L0801_Load2)
PRINT " / "
PRINT (L0801_InitFinished - L0801_Init2)
PRINT " / "
PRINT (L0801_CheckFinished - L0801_Check2)
PRINT "\n"
