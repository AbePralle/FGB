...
;---------------------------------------------------------------------
L0900_Map:
INCBIN "..\\fgbeditor\\l0900_guardpost.lvl"
...
L0900_CheckFinished:
PRINTT "0900 Script Sizes (Load/Init/Check) (of $500):  "
PRINTV (L0900_LoadFinished - L0900_Load2)
PRINTT " / "
PRINTV (L0900_InitFinished - L0900_Init2)
PRINTT " / "
PRINTV (L0900_CheckFinished - L0900_Check2)
PRINTT "\n"
